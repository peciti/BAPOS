...
kernel:
	...
	$(ASM) $(ASM_FLAGS) -o $(BUILD)/kernel/asm/input.obj $(KERNEL_SRC)/library/stdio/input.asm
	...
	$(LD16) NAME $(BUILD)/kernel.bin FILE \{$(BUILD)/kernel/asm/kernel.obj $(BUILD)/kernel/asm/print.obj $(BUILD)/kernel/asm/disk.obj $(BUILD)/kernel/asm/input.obj $(BUILD)/kernel/c/kernel.obj $(BUILD)/kernel/c/stdio.obj \} OPTION MAP=$(BUILD)/kernel.map @$(KERNEL_SRC)/linker.lnk
